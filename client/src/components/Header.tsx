...
const Header: FC = () => {
  ...
  const [fetchProducts] = useLazyQuery<any, { category: string }>(GET_PRODUCTS, {
  ...
  const [fetchData, { loading: dataLoading, error: dataError }] = useLazyQuery<any, { category: string | undefined }>( // Renamed loading and error to avoid conflicts
